"""
Problem Number: 1352. Product of the Last K Numbers
...
int getProduct(int k) Returns the product of the last k numbers in the current list. You
can assume that always the current list has at least k numbers.
...
# add() method: O(1)
# getProduct() method: O(1)
# Space Complexity: O(n)
# In the worst case, when a non-zero number is always added, the list grows linearly
