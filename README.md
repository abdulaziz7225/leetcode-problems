...
├── 📁 Binary_Search
│   ├── 📁 Easy
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Binary_Search/Easy/2529.maximum-count-of-positive-integer-and-negative-integer.py">2529.maximum-count-of-positive-integer-and-negative-integer.py</a>
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Binary_Search/Easy/367.valid-perfect-square.py">367.valid-perfect-square.py</a>
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Binary_Tree/Easy/145.binary-tree-postorder-traversal.py">145.binary-tree-postorder-traversal.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Binary_Tree/Easy/404.sum-of-left-leaves.py">404.sum-of-left-leaves.py</a>
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Binary_Tree/Easy/94.binary-tree-inorder-traversal.py">94.binary-tree-inorder-traversal.py</a>
├── 📁 Bit_Manipulation
│   ├── 📁 Easy
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Bit_Manipulation/Easy/268.missing-number.py">268.missing-number.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Bit_Manipulation/Easy/3304.find-the-k-th-character-in-string-game-i.py">3304.find-the-k-th-character-in-string-game-i.py</a>
...
│   ├── 📁 Medium
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Dynamic_Programming/Medium/1749.maximum-absolute-sum-of-any-subarray.py">1749.maximum-absolute-sum-of-any-subarray.py</a>
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Hash_Table/Easy/205.isomorphic-strings.py">205.isomorphic-strings.py</a>
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Hash_Table/Medium/1930.unique-length-3-palindromic-subsequences.py">1930.unique-length-3-palindromic-subsequences.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Hash_Table/Medium/2364.count-number-of-bad-pairs.py">2364.count-number-of-bad-pairs.py</a>
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Hash_Table/Medium/3159.find-occurrences-of-an-element-in-an-array.py">3159.find-occurrences-of-an-element-in-an-array.py</a>
...
├── 📁 Heap_Priority_Queue
│   ├── 📁 Easy
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Heap_Priority_Queue/Easy/3065.minimum-operations-to-exceed-threshold-value-i.py">3065.minimum-operations-to-exceed-threshold-value-i.py</a>
│   ├── 📁 Medium
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Heap_Priority_Queue/Medium/2342.max-sum-of-a-pair-with-equal-sum-of-digits.py">2342.max-sum-of-a-pair-with-equal-sum-of-digits.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Heap_Priority_Queue/Medium/2349.design-a-number-container-system.py">2349.design-a-number-container-system.py</a>
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Heap_Priority_Queue/Medium/3066.minimum-operations-to-exceed-threshold-value-ii.py">3066.minimum-operations-to-exceed-threshold-value-ii.py</a>
├── 📁 Linked_List
│   ├── 📁 Easy
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Linked_List/Easy/1290.convert-binary-number-in-a-linked-list-to-integer.py">1290.convert-binary-number-in-a-linked-list-to-integer.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Linked_List/Easy/206.reverse-linked-list.py">206.reverse-linked-list.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Linked_List/Easy/83.remove-duplicates-from-sorted-list.py">83.remove-duplicates-from-sorted-list.py</a>
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Linked_List/Easy/876.middle-of-the-linked-list.py">876.middle-of-the-linked-list.py</a>
│   ├── 📁 Medium
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Linked_List/Medium/82.remove-duplicates-from-sorted-list-ii.py">82.remove-duplicates-from-sorted-list-ii.py</a>
├── 📁 Math
│   ├── 📁 Easy
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Math/Easy/1217.minimum-cost-to-move-chips-to-the-same-position.py">1217.minimum-cost-to-move-chips-to-the-same-position.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Math/Easy/1281.subtract-the-product-and-sum-of-digits-of-an-integer.py">1281.subtract-the-product-and-sum-of-digits-of-an-integer.py</a>
...
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Math/Medium/2579.count-total-number-of-colored-cells.py">2579.count-total-number-of-colored-cells.py</a>
├── 📁 Matrix
│   ├── 📁 Easy
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Matrix/Easy/1672.richest-customer-wealth.py">1672.richest-customer-wealth.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Matrix/Easy/2133.check-if-every-row-and-column-contains-all-numbers.py">2133.check-if-every-row-and-column-contains-all-numbers.py</a>
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Matrix/Easy/566.reshape-the-matrix.py">566.reshape-the-matrix.py</a>
│   ├── 📁 Medium
...
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Prefix_Sum/Easy/3432.count-partitions-with-even-sum-difference.py">3432.count-partitions-with-even-sum-difference.py</a>
│   ├── 📁 Medium
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Prefix_Sum/Medium/2615.sum-of-distances.py">2615.sum-of-distances.py</a>
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Prefix_Sum/Medium/3355.zero-array-transformation-i.py">3355.zero-array-transformation-i.py</a>
├── 📁 Sliding_Window
│   ├── 📁 Easy
...
│   ├── 📁 Medium
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Sliding_Window/Medium/1358.number-of-substrings-containing-all-three-characters.py">1358.number-of-substrings-containing-all-three-characters.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Sliding_Window/Medium/187.repeated-dna-sequences.py">187.repeated-dna-sequences.py</a>
...
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Sorting/Medium/56.merge-intervals.py">56.merge-intervals.py</a>
├── 📁 Stack
│   ├── 📁 Easy
...
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Stack/Easy/3174.clear-digits.py">3174.clear-digits.py</a>
│   ├── 📁 Medium
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Stack/Medium/150.evaluate-reverse-polish-notation.py">150.evaluate-reverse-polish-notation.py</a>
...
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/String/Easy/2490.circular-sentence.py">2490.circular-sentence.py</a>
...
│   ├── 📁 Medium
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/String/Medium/3121.count-the-number-of-special-characters-ii.py">3121.count-the-number-of-special-characters-ii.py</a>
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/String/Medium/38.count-and-say.py">38.count-and-say.py</a>
├── 📁 String_Matching
│   ├── 📁 Easy
...
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Tree/Easy/590.n-ary-tree-postorder-traversal.py">590.n-ary-tree-postorder-traversal.py</a>
├── 📁 Trie
│   ├── 📁 Easy
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Trie/Easy/1455.check-if-a-word-occurs-as-a-prefix-of-any-word-in-a-sentence.py">1455.check-if-a-word-occurs-as-a-prefix-of-any-word-in-a-sentence.py</a>
│   │   ├── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Trie/Easy/2185.counting-words-with-a-given-prefix.py">2185.counting-words-with-a-given-prefix.py</a>
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Trie/Easy/3042.count-prefix-and-suffix-pairs-i.py">3042.count-prefix-and-suffix-pairs-i.py</a>
├── 📁 Two_Pointers
│   ├── 📁 Easy
...
│   │   └── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/Two_Pointers/Medium/986.interval-list-intersections.py">986.interval-list-intersections.py</a>
...
└── <a href="https://github.com/swiftv99/leetcode-problems/blob/main/requirements.txt">requirements.txt</a>
</code></pre>
