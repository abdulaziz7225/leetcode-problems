...
arrays nums1 and nums2, where nums1 is a subset of nums2. For each 0 <= i <
...
answer for this query is -1. Return an array ans of length nums1.length such that ans[i]
