"""
Problem Number: 3206. Alternating Groups I
Difficulty Level: Easy
https://leetcode.com/problems/alternating-groups-i

********************************************************************************

There is a circle of red and blue tiles. You are given an array of integers colors. The
...
different color from its left and right tiles) is called an alternating group. Return
the number of alternating groups. Note that since colors represents a circle, the first
