"""
Problem Number: 3194. Minimum Average of Smallest and Largest Elements
Difficulty Level: Easy
https://leetcode.com/problems/minimum-average-of-smallest-and-largest-elements

********************************************************************************

You have an array of floating point numbers averages which is initially empty. You are
given an array nums of n integers where n is even. You repeat the following procedure n
/ 2 times:
