...
Initially, you are at the origin (0, 0). You can change at most k characters to any of
the four directions. Find the maximum Manhattan distance from the origin that can be
...
class Solution:
    def maxDistance(self, s: str, k: int) -> int:
        ...
        for i, char in enumerate(s):
            ...
            result = max(result, min(abs(x_axis) + abs(y_axis) + 2 * k, i + 1))
