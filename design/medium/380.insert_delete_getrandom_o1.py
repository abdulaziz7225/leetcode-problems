"""
Problem Number: 380. Insert Delete GetRandom O(1)
...
guaranteed that at least one element exists when 
...
class RandomizedSet:
    ...
    def remove(self, val: int) -> bool:
        ...
        self.list[self.hashmap[val]] = last_elem
        self.hashmap[last_elem] = self.hashmap[val]
