...
are identical. For example, if nums = [10, 8, 10, 8], a valid integer is h = 9 because
...
k. If it is impossible to make all elements equal to k, return -1.
    ...
    def minOperations(self, nums: List[int], k: int) -> int:
        ...
        for num in nums:
            if num < k:
                ...
                larger_than_k.add(num)
        return len(larger_than_k)
